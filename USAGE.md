...
A minimal inline-netlist call is `ssas.solve(netlist, "V(out) / V(in)", "rc_lowpass.md", source="inline")`. A file-netlist call is `ssas.solve("netlists/cs_amp.sp", "V(out) / V(in)", "cs_gain.md", source="file")`.
