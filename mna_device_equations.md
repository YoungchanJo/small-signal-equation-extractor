...
$$
C_{M,gd}\in\mathrm{zero}\_\mathrm{cap}\quad\Rightarrow\quad
...
$$
R_D\in\mathrm{zero}\_\mathrm{resistance}\quad\Rightarrow\quad
\begin{cases}
...
$$
r_M\in\mathrm{zero}\_\mathrm{resistance}\quad\Rightarrow\quad
\begin{cases}
...
$$
L_D\in\mathrm{zero}\_\mathrm{inductance}\quad\Rightarrow\quad
\begin{cases}
